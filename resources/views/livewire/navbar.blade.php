        ...
        <div class="fixed inset-0 z-40 flex">
            <div
                    ...
                    <div id="tabs-1-panel-1" class="px-4 pt-10 pb-8 space-y-10" aria-labelledby="tabs-1-tab-1"
                        ...
                        <div>
                            ...
                            <ul role="list" aria-labelledby="women-clothing-heading-mobile"
                                ...
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">Tops</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Dresses</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">Pants</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">Denim</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Sweaters</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">T-Shirts</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Jackets</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Activewear</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">Browse
                                        All</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul role="list" aria-labelledby="women-accessories-heading-mobile"
                                ...
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Watches</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Wallets</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">Bags</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Sunglasses</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">Hats</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Belts</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul role="list" aria-labelledby="women-brands-heading-mobile"
                                class="flex flex-col mt-6 space-y-6">
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">Full
                                        Nelson</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500">My
                                        Way</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Re-Arranged</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Counterfeit</a>
                                </li>
                                <li class="flow-root">
                                    <a href="#"
                                        class="block p-2 -m-2 text-gray-500">Significant Other</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="px-4 py-6 space-y-6 border-t border-gray-200">
                    <div class="flow-root">
                        <a href="#"
                            class="block p-2 -m-2 font-medium text-gray-900">Company</a>
                    </div>
                    <div class="flow-root">
                        <a href="#"
                            class="block p-2 -m-2 font-medium text-gray-900">Stores</a>
                    </div>
                </div>

                <div class="px-4 py-6 space-y-6 border-t border-gray-200">
                    <div class="flow-root">
                        <a href="#" class="block p-2 -m-2 font-medium text-gray-900">Sign
                            in</a>
                    </div>
                    <div class="flow-root">
                        <a href="#" class="block p-2 -m-2 font-medium text-gray-900">Create
                            account</a>
                    </div>
                </div>
                        ...
                        <div class="flex h-full space-x-8">
                            <div class="flex">
                                <div class="relative flex">
                                    <!-- Item active: "border-primary-600 text-primary-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" -->
                                    <button type="button"
